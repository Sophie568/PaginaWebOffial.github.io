...
novClose = document.getElementById('nov-close')
...
/* Validate if constant exists */
if(novClose) {
    novClose.addEventListener("click", () => {
...
function scrollUp() {
    ...
    // when the scroll is hegher than 350 viewport height, add the show-scroll class to a tag with the scroll-top class
...
function themeColors() {
    ...
    themeColorsContainer.addEventListener("click", ({target}) => {
       ...
       function setColors() {
        let path = colorStyle.getAttribute("hrf").split("/");
